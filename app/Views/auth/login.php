...
<div class="max-w-7xl mx-auto py-6 flex items-center justify-center min-h-screen">
    ...
    <div class="container-shadow p-6 w-full max-w-md">
        <h1 class="text-2xl font-bold text-gray-800 mb-4 text-center">Login to EpicClub</h1>
        <?php if ($error): ?>
        ...
        <form method="POST" action="/login">
            ...
            <div class="space-y-4">
                ...
                <p class="text-gray-600 text-center">Don't have an account? <a href="/register" class="text-blue-500 hover:underline">Register</a></p>
            </div>
        </form>
    </div>
</div>
